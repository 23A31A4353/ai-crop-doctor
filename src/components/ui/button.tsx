  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-lg hover:shadow-glow hover:-translate-y-1 active:translate-y-0",
        voice: "bg-gradient-to-r from-secondary to-secondary/80 text-secondary-foreground rounded-full shadow-lg hover:shadow-glow-accent hover:scale-105 active:scale-95",
        language: "bg-card border-2 border-border text-foreground hover:border-primary hover:bg-primary/5 shadow-sm",
        crop: "bg-card border-2 border-border text-foreground hover:border-accent hover:bg-accent/10 shadow-sm hover:shadow-md",
      },
      size: {
